 ...
 */
package com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers;  
...
public class identifierFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder();
  }
  
  /** Creates a new identifierFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder(other);
  }
  
  /** Creates a new identifierFields RecordBuilder by copying an existing identifierFields instance */
  public static com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields other) {
    return new com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<identifierFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields other) {
            super(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.SCHEMA$);
      if (isValidValue(fields()[0], other.NAME_BUSINESS_COMPANY_TYPE)) {
        this.NAME_BUSINESS_COMPANY_TYPE = data().deepCopy(fields()[0].schema(), other.NAME_BUSINESS_COMPANY_TYPE);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'NAME_BUSINESS_COMPANY_TYPE' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setNAMEBUSINESSCOMPANYTYPE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearNAMEBUSINESSCOMPANYTYPE() {
    ...
    /** Sets the value of the 'IDENTIFIER_BUSINESS_VAT' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setIDENTIFIERBUSINESSVAT(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearIDENTIFIERBUSINESSVAT() {
    ...
    /** Sets the value of the 'IDENTIFIER_BUSINESS_EMAIL' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setIDENTIFIERBUSINESSEMAIL(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearIDENTIFIERBUSINESSEMAIL() {
    ...
    /** Sets the value of the 'IDENTIFIER_DISSOLVED_DATE' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setIDENTIFIERDISSOLVEDDATE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearIDENTIFIERDISSOLVEDDATE() {
    ...
    /** Sets the value of the 'IDENTIFIER_INCORPORATION_DATE' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setIDENTIFIERINCORPORATIONDATE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearIDENTIFIERINCORPORATIONDATE() {
    ...
    /** Sets the value of the 'IDENTIFIER_UPDATE_DATE' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setIDENTIFIERUPDATEDATE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearIDENTIFIERUPDATEDATE() {
    ...
    /** Sets the value of the 'IDENTIFIER_DATA_SOURCE' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder setIDENTIFIERDATASOURCE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.identifiers.identifierFields.Builder clearIDENTIFIERDATASOURCE() {
