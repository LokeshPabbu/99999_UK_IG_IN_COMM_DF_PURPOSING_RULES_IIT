 ...
 */
package com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata;  
...
public class discoveryDataFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public java.lang.Object get(int field$) {
    switch (field$) {
    case 0: return DISCOVERY_ACCOUNT_NUMBER;
    case 1: return DISCOVERY_CLIENT_NUMBER;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: DISCOVERY_ACCOUNT_NUMBER = (java.lang.CharSequence)value$; break;
    case 1: DISCOVERY_CLIENT_NUMBER = (java.lang.CharSequence)value$; break;
  ...
  public static com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder();
  }
  
  /** Creates a new discoveryDataFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder(other);
  }
  
  /** Creates a new discoveryDataFields RecordBuilder by copying an existing discoveryDataFields instance */
  public static com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields other) {
    return new com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<discoveryDataFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.DISCOVERY_ACCOUNT_NUMBER)) {
        this.DISCOVERY_ACCOUNT_NUMBER = data().deepCopy(fields()[0].schema(), other.DISCOVERY_ACCOUNT_NUMBER);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.DISCOVERY_CLIENT_NUMBER)) {
        this.DISCOVERY_CLIENT_NUMBER = data().deepCopy(fields()[1].schema(), other.DISCOVERY_CLIENT_NUMBER);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields other) {
            super(com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.SCHEMA$);
      if (isValidValue(fields()[0], other.DISCOVERY_ACCOUNT_NUMBER)) {
        this.DISCOVERY_ACCOUNT_NUMBER = data().deepCopy(fields()[0].schema(), other.DISCOVERY_ACCOUNT_NUMBER);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'DISCOVERY_ACCOUNT_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYACCOUNTNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYACCOUNTNUMBER() {
    ...
    /** Sets the value of the 'DISCOVERY_CLIENT_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYCLIENTNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYCLIENTNUMBER() {
    ...
    /** Sets the value of the 'DISCOVERY_FACILITY_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYFACILITYNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYFACILITYNUMBER() {
    ...
    /** Sets the value of the 'DISCOVERY_DEFENDENT_ID' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYDEFENDENTID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYDEFENDENTID() {
    ...
    /** Sets the value of the 'DISCOVERY_DRC_ID' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYDRCID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYDRCID() {
    ...
    /** Sets the value of the 'DISCOVERY_URN' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYURN(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYURN() {
      DISCOVERY_URN = null;
    ...
    /** Sets the value of the 'DISCOVERY_CASE_ID' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYCASEID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYCASEID() {
    ...
    /** Sets the value of the 'DISCOVERY_CLN_BUSINESS_NAME' field */
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYCLNBUSINESSNAME(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officerresidentialaddr.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYCLNBUSINESSNAME() {
    ...
    public discoveryDataFields build() {
      try {
        ...
        record.DISCOVERY_ACCOUNT_NUMBER = fieldSetFlags()[0] ? this.DISCOVERY_ACCOUNT_NUMBER : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.DISCOVERY_CLIENT_NUMBER = fieldSetFlags()[1] ? this.DISCOVERY_CLIENT_NUMBER : (java.lang.CharSequence) defaultValue(fields()[1]);
