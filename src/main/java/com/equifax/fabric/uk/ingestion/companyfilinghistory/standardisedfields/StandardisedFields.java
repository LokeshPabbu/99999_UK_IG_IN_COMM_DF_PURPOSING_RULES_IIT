 ...
 */
package com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields;  
...
public class StandardisedFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields entity;
   ...
   */
  public StandardisedFields(java.lang.CharSequence COMPANY_REGISTERED_NUMBER, java.lang.CharSequence DESCRIPTION, java.lang.CharSequence PROCESSING_DATE, java.lang.CharSequence FORMAT_OF_SUPPLY, java.lang.CharSequence MIGRATION_FLAG, com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields entity) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: entity = (com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields getEntity() {
    return entity;
  }
   ...
   */
  public void setEntity(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields value) {
    this.entity = value;
  }

  /** Creates a new StandardisedFields RecordBuilder */
  public static com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder();
  }
  
  /** Creates a new StandardisedFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder(other);
  }
  
  /** Creates a new StandardisedFields RecordBuilder by copying an existing StandardisedFields instance */
  public static com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields other) {
    return new com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StandardisedFields>
    ...
    private com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields entity;

    /** Creates a new Builder */
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields other) {
            super(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.SCHEMA$);
      if (isValidValue(fields()[0], other.COMPANY_REGISTERED_NUMBER)) {
        this.COMPANY_REGISTERED_NUMBER = data().deepCopy(fields()[0].schema(), other.COMPANY_REGISTERED_NUMBER);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'COMPANY_REGISTERED_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder setCOMPANYREGISTEREDNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder clearCOMPANYREGISTEREDNUMBER() {
    ...
    /** Sets the value of the 'DESCRIPTION' field */
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder setDESCRIPTION(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder clearDESCRIPTION() {
      DESCRIPTION = null;
    ...
    /** Sets the value of the 'PROCESSING_DATE' field */
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder setPROCESSINGDATE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder clearPROCESSINGDATE() {
    ...
    /** Sets the value of the 'FORMAT_OF_SUPPLY' field */
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder setFORMATOFSUPPLY(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder clearFORMATOFSUPPLY() {
    ...
    /** Sets the value of the 'MIGRATION_FLAG' field */
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder setMIGRATIONFLAG(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder clearMIGRATIONFLAG() {
      MIGRATION_FLAG = null;
    ...
    /** Sets the value of the 'entity' field */
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder setEntity(com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.StandardisedFields.Builder clearEntity() {
      entity = null;
    ...
    public StandardisedFields build() {
      try {
        ...
        record.entity = fieldSetFlags()[5] ? this.entity : (com.equifax.fabric.uk.ingestion.companyfilinghistory.standardisedfields.entity.entityFields) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {
