 ...
 */
package com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity;  
...
public class entityFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public entityFields(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields commercial) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: commercial = (com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields getCommercial() {
    return commercial;
  }
   ...
   */
  public void setCommercial(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields value) {
    this.commercial = value;
  }

  /** Creates a new entityFields RecordBuilder */
  public static com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder();
  }
  
  /** Creates a new entityFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder(other);
  }
  
  /** Creates a new entityFields RecordBuilder by copying an existing entityFields instance */
  public static com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields other) {
    return new com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<entityFields>
    ...
    private com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields commercial;

    /** Creates a new Builder */
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields other) {
            super(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.SCHEMA$);
      if (isValidValue(fields()[0], other.commercial)) {
        this.commercial = data().deepCopy(fields()[0].schema(), other.commercial);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'commercial' field */
    public com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder setCommercial(com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields value) {
    ...
    public com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.entityFields.Builder clearCommercial() {
      commercial = null;
    ...
    public entityFields build() {
      try {
        ...
        record.commercial = fieldSetFlags()[0] ? this.commercial : (com.equifax.fabric.uk.ingestion.ccdsaccount.standardisedfields.entity.commercial.commercialFields) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
