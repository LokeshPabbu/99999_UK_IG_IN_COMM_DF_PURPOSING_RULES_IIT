 ...
 */
package com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata;  
...
public class discoveryDataFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public discoveryDataFields(java.lang.CharSequence DISCOVERY_CLIENT_NUMBER, java.lang.CharSequence DISCOVERY_FACILITY_NUMBER, java.lang.CharSequence DISCOVERY_DEFENDENT_ID, java.lang.CharSequence DISCOVERY_DRC_ID, java.lang.CharSequence DISCOVERY_URN, java.lang.CharSequence DISCOVERY_CASE_ID, java.lang.CharSequence DISCOVERY_CLN_BUSINESS_NAME, java.lang.CharSequence DISCOVERY_ACCOUNT_NUMBER) {
  ...
  public java.lang.Object get(int field$) {
    ...
    case 1: return DISCOVERY_FACILITY_NUMBER;
    case 2: return DISCOVERY_DEFENDENT_ID;
    case 3: return DISCOVERY_DRC_ID;
    case 4: return DISCOVERY_URN;
    case 5: return DISCOVERY_CASE_ID;
    case 6: return DISCOVERY_CLN_BUSINESS_NAME;
    case 7: return DISCOVERY_ACCOUNT_NUMBER;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: DISCOVERY_FACILITY_NUMBER = (java.lang.CharSequence)value$; break;
    case 2: DISCOVERY_DEFENDENT_ID = (java.lang.CharSequence)value$; break;
    case 3: DISCOVERY_DRC_ID = (java.lang.CharSequence)value$; break;
    case 4: DISCOVERY_URN = (java.lang.CharSequence)value$; break;
    case 5: DISCOVERY_CASE_ID = (java.lang.CharSequence)value$; break;
    case 6: DISCOVERY_CLN_BUSINESS_NAME = (java.lang.CharSequence)value$; break;
    case 7: DISCOVERY_ACCOUNT_NUMBER = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder();
  }
  
  /** Creates a new discoveryDataFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder(other);
  }
  
  /** Creates a new discoveryDataFields RecordBuilder by copying an existing discoveryDataFields instance */
  public static com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields other) {
    return new com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<discoveryDataFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[1], other.DISCOVERY_FACILITY_NUMBER)) {
        this.DISCOVERY_FACILITY_NUMBER = data().deepCopy(fields()[1].schema(), other.DISCOVERY_FACILITY_NUMBER);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.DISCOVERY_DEFENDENT_ID)) {
        this.DISCOVERY_DEFENDENT_ID = data().deepCopy(fields()[2].schema(), other.DISCOVERY_DEFENDENT_ID);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.DISCOVERY_DRC_ID)) {
        this.DISCOVERY_DRC_ID = data().deepCopy(fields()[3].schema(), other.DISCOVERY_DRC_ID);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.DISCOVERY_URN)) {
        this.DISCOVERY_URN = data().deepCopy(fields()[4].schema(), other.DISCOVERY_URN);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.DISCOVERY_CASE_ID)) {
        this.DISCOVERY_CASE_ID = data().deepCopy(fields()[5].schema(), other.DISCOVERY_CASE_ID);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.DISCOVERY_CLN_BUSINESS_NAME)) {
        this.DISCOVERY_CLN_BUSINESS_NAME = data().deepCopy(fields()[6].schema(), other.DISCOVERY_CLN_BUSINESS_NAME);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.DISCOVERY_ACCOUNT_NUMBER)) {
        this.DISCOVERY_ACCOUNT_NUMBER = data().deepCopy(fields()[7].schema(), other.DISCOVERY_ACCOUNT_NUMBER);
        fieldSetFlags()[7] = true;
      }
    }
    
    /** Creates a Builder by copying an existing discoveryDataFields instance */
    private Builder(com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields other) {
            super(com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.SCHEMA$);
      if (isValidValue(fields()[0], other.DISCOVERY_CLIENT_NUMBER)) {
        this.DISCOVERY_CLIENT_NUMBER = data().deepCopy(fields()[0].schema(), other.DISCOVERY_CLIENT_NUMBER);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'DISCOVERY_CLIENT_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYCLIENTNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYCLIENTNUMBER() {
    ...
    /** Sets the value of the 'DISCOVERY_FACILITY_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYFACILITYNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYFACILITYNUMBER() {
    ...
    /** Sets the value of the 'DISCOVERY_DEFENDENT_ID' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYDEFENDENTID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYDEFENDENTID() {
    ...
    /** Sets the value of the 'DISCOVERY_DRC_ID' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYDRCID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYDRCID() {
    ...
    /** Sets the value of the 'DISCOVERY_URN' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYURN(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYURN() {
      DISCOVERY_URN = null;
    ...
    /** Sets the value of the 'DISCOVERY_CASE_ID' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYCASEID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYCASEID() {
    ...
    /** Sets the value of the 'DISCOVERY_CLN_BUSINESS_NAME' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYCLNBUSINESSNAME(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYCLNBUSINESSNAME() {
    ...
    /** Sets the value of the 'DISCOVERY_ACCOUNT_NUMBER' field */
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder setDISCOVERYACCOUNTNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.companyfinancialstatement.standardisedfields.entity.commercial.discoverydata.discoveryDataFields.Builder clearDISCOVERYACCOUNTNUMBER() {
    ...
    public discoveryDataFields build() {
      try {
        ...
        record.DISCOVERY_FACILITY_NUMBER = fieldSetFlags()[1] ? this.DISCOVERY_FACILITY_NUMBER : (java.lang.CharSequence) defaultValue(fields()[1]);
        record.DISCOVERY_DEFENDENT_ID = fieldSetFlags()[2] ? this.DISCOVERY_DEFENDENT_ID : (java.lang.CharSequence) defaultValue(fields()[2]);
        record.DISCOVERY_DRC_ID = fieldSetFlags()[3] ? this.DISCOVERY_DRC_ID : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.DISCOVERY_URN = fieldSetFlags()[4] ? this.DISCOVERY_URN : (java.lang.CharSequence) defaultValue(fields()[4]);
        record.DISCOVERY_CASE_ID = fieldSetFlags()[5] ? this.DISCOVERY_CASE_ID : (java.lang.CharSequence) defaultValue(fields()[5]);
        record.DISCOVERY_CLN_BUSINESS_NAME = fieldSetFlags()[6] ? this.DISCOVERY_CLN_BUSINESS_NAME : (java.lang.CharSequence) defaultValue(fields()[6]);
        record.DISCOVERY_ACCOUNT_NUMBER = fieldSetFlags()[7] ? this.DISCOVERY_ACCOUNT_NUMBER : (java.lang.CharSequence) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
