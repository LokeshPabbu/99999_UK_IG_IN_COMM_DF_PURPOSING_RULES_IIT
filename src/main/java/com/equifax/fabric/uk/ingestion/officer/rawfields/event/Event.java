...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder();
  }
  
  /** Creates a new Event RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder newBuilder(com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder other) {
    return new com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder(other);
  }
  
  /** Creates a new Event RecordBuilder by copying an existing Event instance */
  public static com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder newBuilder(com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event other) {
    return new com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event other) {
            super(com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.SCHEMA$);
      if (isValidValue(fields()[0], other.fields_changed)) {
        this.fields_changed = data().deepCopy(fields()[0].schema(), other.fields_changed);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'fields_changed' field */
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder setFieldsChanged(java.util.List<java.lang.CharSequence> value) {
    ...
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder clearFieldsChanged() {
      fields_changed = null;
    ...
    /** Sets the value of the 'published_at' field */
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder setPublishedAt(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder clearPublishedAt() {
      published_at = null;
    ...
    /** Sets the value of the 'timepoint' field */
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder setTimepoint(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder clearTimepoint() {
      timepoint = null;
    ...
    /** Sets the value of the 'type' field */
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder setType(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.officer.rawfields.event.Event.Builder clearType() {
      type = null;
