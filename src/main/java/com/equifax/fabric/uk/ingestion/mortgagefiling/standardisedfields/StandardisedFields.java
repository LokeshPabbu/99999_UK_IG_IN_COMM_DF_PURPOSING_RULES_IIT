 ...
 */
package com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields;  
...
public class StandardisedFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields entity;
   ...
   */
  public StandardisedFields(java.lang.CharSequence stdCompanyRegisteredNumber_DER, java.lang.CharSequence stdProcessingDate, java.lang.CharSequence stdFormatOfSupply, java.lang.CharSequence stdMigrationFlag, com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields entity) {
    this.stdCompanyRegisteredNumber_DER = stdCompanyRegisteredNumber_DER;
  ...
  public java.lang.Object get(int field$) {
    switch (field$) {
    case 0: return stdCompanyRegisteredNumber_DER;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: stdCompanyRegisteredNumber_DER = (java.lang.CharSequence)value$; break;
    ...
    case 4: entity = (com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }

  /**
   * Gets the value of the 'stdCompanyRegisteredNumber_DER' field.
   * Standarized Company Number   */
  public java.lang.CharSequence getStdCompanyRegisteredNumberDER() {
    return stdCompanyRegisteredNumber_DER;
  }

  /**
   * Sets the value of the 'stdCompanyRegisteredNumber_DER' field.
   * Standarized Company Number   * @param value the value to set.
   */
  public void setStdCompanyRegisteredNumberDER(java.lang.CharSequence value) {
    this.stdCompanyRegisteredNumber_DER = value;
  }
   ...
   */
  public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields getEntity() {
    return entity;
  }
   ...
   */
  public void setEntity(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields value) {
    this.entity = value;
  }

  /** Creates a new StandardisedFields RecordBuilder */
  public static com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder();
  }
  
  /** Creates a new StandardisedFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder(other);
  }
  
  /** Creates a new StandardisedFields RecordBuilder by copying an existing StandardisedFields instance */
  public static com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields other) {
    return new com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StandardisedFields>
    ...
    private java.lang.CharSequence stdCompanyRegisteredNumber_DER;
    ...
    private com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields entity;

    /** Creates a new Builder */
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.stdCompanyRegisteredNumber_DER)) {
        this.stdCompanyRegisteredNumber_DER = data().deepCopy(fields()[0].schema(), other.stdCompanyRegisteredNumber_DER);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields other) {
            super(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.SCHEMA$);
      if (isValidValue(fields()[0], other.stdCompanyRegisteredNumber_DER)) {
        this.stdCompanyRegisteredNumber_DER = data().deepCopy(fields()[0].schema(), other.stdCompanyRegisteredNumber_DER);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'stdCompanyRegisteredNumber_DER' field */
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder setStdCompanyRegisteredNumberDER(java.lang.CharSequence value) {
    ...
    /** Checks whether the 'stdCompanyRegisteredNumber_DER' field has been set */
    public boolean hasStdCompanyRegisteredNumberDER() {
      return fieldSetFlags()[0];
    }
    
    /** Clears the value of the 'stdCompanyRegisteredNumber_DER' field */
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder clearStdCompanyRegisteredNumberDER() {
      stdCompanyRegisteredNumber_DER = null;
    ...
    /** Sets the value of the 'stdProcessingDate' field */
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder setStdProcessingDate(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder clearStdProcessingDate() {
    ...
    /** Sets the value of the 'stdFormatOfSupply' field */
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder setStdFormatOfSupply(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder clearStdFormatOfSupply() {
    ...
    /** Sets the value of the 'stdMigrationFlag' field */
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder setStdMigrationFlag(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder clearStdMigrationFlag() {
    ...
    /** Sets the value of the 'entity' field */
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder setEntity(com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields value) {
    ...
    public com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.StandardisedFields.Builder clearEntity() {
      entity = null;
    ...
    public StandardisedFields build() {
      try {
        ...
        record.stdCompanyRegisteredNumber_DER = fieldSetFlags()[0] ? this.stdCompanyRegisteredNumber_DER : (java.lang.CharSequence) defaultValue(fields()[0]);
        ...
        record.entity = fieldSetFlags()[4] ? this.entity : (com.equifax.fabric.uk.ingestion.mortgagefiling.standardisedfields.entity.entityFields) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
