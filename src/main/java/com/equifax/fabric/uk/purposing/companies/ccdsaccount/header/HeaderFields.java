 ...
 */
package com.equifax.fabric.uk.purposing.companies.ccdsaccount.header;  
...
public class HeaderFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder();
  }
  
  /** Creates a new HeaderFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder newBuilder(com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder other) {
    return new com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder(other);
  }
  
  /** Creates a new HeaderFields RecordBuilder by copying an existing HeaderFields instance */
  public static com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder newBuilder(com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields other) {
    return new com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HeaderFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields other) {
            super(com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.SCHEMA$);
      if (isValidValue(fields()[0], other.H_DATE_IN_HEADER)) {
        this.H_DATE_IN_HEADER = data().deepCopy(fields()[0].schema(), other.H_DATE_IN_HEADER);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'H_DATE_IN_HEADER' field */
    public com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder setHDATEINHEADER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder clearHDATEINHEADER() {
    ...
    /** Sets the value of the 'H_SUPPLIED_SOURCE_CODE' field */
    public com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder setHSUPPLIEDSOURCECODE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.purposing.companies.ccdsaccount.header.HeaderFields.Builder clearHSUPPLIEDSOURCECODE() {
