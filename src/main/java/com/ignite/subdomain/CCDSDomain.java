...
public class CCDSDomain implements Serializable {
//    private static final Logger LOGGER = LoggerFactory.getLogger(CCDSDomain.class);
    public static PCollection<GenericRecord> getCCDSData(CustomPipelineOptions options, Pipeline pipeline) throws IOException {
