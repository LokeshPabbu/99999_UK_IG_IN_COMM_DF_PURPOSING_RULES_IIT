 ...
 */
public class TableRowToGenericRecordConverterFn  extends DoFn<TableRow, GenericRecord> implements Serializable {
    ...
    try {
       ...
       // LOGGER.error("Error:", e);
        throw new TransformationBQ.IgniteTransformationException("Exception",e);
    }
    }
    ...
    //                    return String.valueOf(originalValue).getBytes(StandardCharsets.UTF_8);
            ...
            //LOGGER.error("Error:", e);
            throw new TransformationBQ.IgniteTransformationException("",e);
        }
    }
